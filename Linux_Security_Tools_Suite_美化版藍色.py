...
class MainWindow(QtWidgets.QMainWindow):
    ...
    QListWidget { background: #f3f3f3; border: none; padding:6px; }
    QListWidget::item { padding:10px; border-radius:3px; }
    QListWidget::item:selected { background:#0078d7; color:white; font-weight:600; }
""")
    ...
    def _apply_style(self):
        try:
            ...
            qss = """
            QWidget { font-family: "Segoe UI"; background-color: #f0f0f0; }
            QPushButton {
                padding:6px 12px;
            ...
            QPushButton:hover { background-color:#e6f1fb; border-color:#0078d7; }
            QPushButton:pressed { background-color:#cce4f7; border-color:#005a9e; }
            ...
            QListWidget::item { padding:10px; border-radius:3px; }
            QListWidget::item:selected { background-color:#0078d7; color:white; font-weight:600; }
